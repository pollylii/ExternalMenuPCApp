...
//JS DES加密函数    
function JSDESEncrypt(message) {
    var ciphertext = stringToHex(des(_platinumDESKey, message, 1, 0));
    return ciphertext;
}
...
//JS DES解密函数
function JSDESDecrypt(message) {
    var plaintext = des(_platinumDESKey, HexTostring(message), 0, 0);
    return plaintext;
}